...
def test_yolo_coco_basic() -> bool:
    """Test básico del detector YOLO COCO."""
    print("🧪 Test: YOLO COCO Básico")
    ...
    try:
        ...
        assert hasattr(detector, 'detect_social_objects')
        assert hasattr(detector, 'get_detection_summary')
